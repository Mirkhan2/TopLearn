...
namespace TopLearn.DataLayeer.Migrations
{
    ...
    [Migration("20231111130313_ChangeAnswerIsTrue")]
    partial class ChangeAnswerIsTrue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.Course", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseComment", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseEpisode", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseLevel", b =>
                {
                    b.Property<int>("LevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseVote", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.UserCourse", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Order.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Question.Answer", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Question.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.User.UserDiscountCode", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.Course", b =>
                {
                    b.HasOne("TopLearn.DataLayeer.Entities.Course.CourseGroup", "CourseGroup")
                        .WithMany("Courses")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayeer.Entities.Course.CourseLevel", "CourseLevel")
                        .WithMany("Courses")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayeer.Entities.Course.CourseStatus", "CourseStatus")
                        .WithMany("Courses")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TopLearn.DataLayeer.Entities.Course.CourseGroup", "Group")
                        .WithMany("SubGroup")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Course.CourseComment", b =>
                {
                    b.HasOne("TopLearn.DataLayeer.Entities.Course.Course", "Course")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Order.OrderDetail", b =>
                {
                    ...
                    b.HasOne("TopLearn.DataLayeer.Entities.Order.Order", "Order")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.Question.Answer", b =>
                {
                    b.HasOne("TopLearn.DataLayeer.Entities.Question.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("TopLearn.DataLayeer.Entities.User.UserDiscountCode", b =>
                {
                    b.HasOne("TopLearn.DataLayeer.Entities.Order.Discount", "Discount")
