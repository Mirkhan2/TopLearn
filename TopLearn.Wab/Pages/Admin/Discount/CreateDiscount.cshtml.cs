...
namespace TopLearn.Wab.Pages.Admin.Discount
{
    public class CreateDiscountModel : PageModel
    {
        ...
        [BindProperty]
        public DataLayeer.Entities.Order.Discount Discount { get; set; }
        public void OnGet()
        {
        ...
        public IActionResult OnPost(string stDate = "", string edDate = "")
        {
            ...
            if (!ModelState.IsValid && _orderService.IsExitCode(Discount.DiscountCode))
                return Page();
        ...
        public IActionResult OnGetCheckCode(string code)
        {
            ...
            return Content(_orderService.IsExitCode(code).ToString());
        }
